use clap::Parser;
use fluss_rust::metadata::{DataTypes, Schema, TableDescriptor, TablePath};
use fluss_rust::new::args::Config;
use fluss_rust::new::client::GenericRow;
...
pub async fn main() -> Result<()> {
    ...
    config.bootstrap_server = Some("127.0.0.1:49822".to_string());
